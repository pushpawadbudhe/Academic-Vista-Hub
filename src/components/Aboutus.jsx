...
const Aboutus = () => {
  return (
    <main id="about" className="pt-20 bg-primary">
      <div class="bg-primary relative   flex items-center  justify-center overflow-hidden z-50 ">
          ...
          <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative ">
              ...
              <div class="lg:max-w-xl lg:pr-5 relative z-40">
                ...
                <h2 class="mb-6 max-w-lg text-5xl font-light text-cyan-300 leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                  Welcome to Academic Vista
                  <span class="my-1 ml-2 inline-block border-b-8 border-g4 bg-white text-primary px-4 font-bold text-g4 animate__animated animate__flash">
                  &lt; Hub /&gt;
                  </span>
                </h2>
                <p class="text-base text-cyan-500">
                We connect aspiring students with tailored internship opportunities, fostering growth, and building pathways to success.
                </p>
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
              ...
              <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                <img src="https://images.unsplash.com/photo-1455849318743-b2233052fcff?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
              </div>
            </div>
          </div>
        </div>
